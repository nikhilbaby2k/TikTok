 ...
 * Generated for Laravel 5.1.27 (LTS) on 2015-12-30.
 *
...
namespace {
    ...
    class DB extends \Illuminate\Support\Facades\DB{
        ...
        public static function connection($name = null){
            ...
            return \Firebird\DatabaseManager::connection($name);
        }
        ...
        public static function purge($name = null){
            //Method inherited from \Illuminate\Database\DatabaseManager            
            \Firebird\DatabaseManager::purge($name);
        }
        ...
        public static function disconnect($name = null){
            //Method inherited from \Illuminate\Database\DatabaseManager            
            \Firebird\DatabaseManager::disconnect($name);
        }
        ...
        public static function reconnect($name = null){
            //Method inherited from \Illuminate\Database\DatabaseManager            
            return \Firebird\DatabaseManager::reconnect($name);
        }
        ...
        public static function getDefaultConnection(){
            //Method inherited from \Illuminate\Database\DatabaseManager            
            return \Firebird\DatabaseManager::getDefaultConnection();
        }
        ...
        public static function setDefaultConnection($name){
            //Method inherited from \Illuminate\Database\DatabaseManager            
            \Firebird\DatabaseManager::setDefaultConnection($name);
        }
        ...
        public static function extend($name, $resolver){
            //Method inherited from \Illuminate\Database\DatabaseManager            
            \Firebird\DatabaseManager::extend($name, $resolver);
        }
        ...
        public static function getConnections(){
            //Method inherited from \Illuminate\Database\DatabaseManager            
            return \Firebird\DatabaseManager::getConnections();
        }
